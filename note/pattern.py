...
pattern_function = MarkdownPattern('function')
patterns.append(pattern_function)
pattern_function.origin = rf"""
       1     2   3 file                 {re_code_len}  4   5 arg         6   7          8                9    
(?<=\n)(<!--)(\s)((?:[\w\d\/]+)(?:\.)(?:{re_code_str}))(\s)(function:\w+)(\s)(-->)(?=\n)([\s\S]+?)(?<=\n)(<!--\s+-->)(?=\n)
"""
pattern_function.replace = r'\1\2\3\4\5\6\7\n' \
                           r'```{type}\n' \
                           r'{code}\n' \
                           r'```\n' \
                           r'\9'
...
pattern_function.function = get_type_code_slice
